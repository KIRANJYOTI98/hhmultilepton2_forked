...
def add_config(
    ...
    # =============================================
    # channels we have so far --> check analysis.yaml
    # 2 lep: "etau", "mutau", "tautau", "ee", "mumu", "emu",
    # 3 lep: "c3e", "c2emu", "ce2mu", "c3mu",
    # 4 lep (no taus): "c4e", "c3emu", "c2e2mu", "ce3mu", "c4mu",
    # 4 lep with taus:
    #   3l1tau: "c3etau", "c2emutau", "ce2mutau", "c3mutau",
    #   2l2tau: "c2e2tau", "c2mu2tau", "cemu2tau",
    #   1l3tau: "ce3tau", "cmu3tau",
    #   4tau: "c4tau",
    #   2lss 0 or 1 tau: "c2e0or1tau", "cemu0or1tau", "c2mu0or1tau",
    # =============================================
